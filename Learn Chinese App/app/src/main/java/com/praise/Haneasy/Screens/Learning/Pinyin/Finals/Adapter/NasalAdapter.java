...
public class NasalAdapter extends RecyclerView.Adapter<NasalAdapter.ViewHolder>{
    Context context;
    ArrayList<PinyinModal> modals;
    NasalInterface clickInterface;

    public NasalAdapter(Context context, ArrayList<PinyinModal> modals, NasalInterface clickInterface) {
    ...
    @Override
    public void onBindViewHolder(@NonNull  NasalAdapter.ViewHolder holder, int position) {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    clickInterface.onNasalClick(getAdapterPosition());
                }
            });
        }
    }
